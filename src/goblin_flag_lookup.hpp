...
MapFragments(goblin::flag::GravesitePlain,
	{
		MapChunk(20), // Belurat
		MapChunk(20, 1), // Enir-Ilim
		MapChunk(41), // Belurat Gaol
		MapChunk(43), // Rivermouth Cave
		MapChunk(42), // Ruined Forge Lava Intake
		MapChunk(42, 2), // Ruined Forge of Starfall Past
		MapChunk(43, 1), // Dragon's Pit
		MapChunk(41, 2), // Lamenter's Gaol
		MapChunk(61, 43, 45),
		MapChunk(61, 44, 45),
		MapChunk(61, 45, 45),
		MapChunk(61, 46, 45),
...
MapFragments(goblin::flag::ScaduAltus,
	{
		MapChunk(21), // Shadow Keep
		MapChunk(21, 1), // Specimen Storehouse
		MapChunk(21, 2), // Specimen Storehouse (West Rampart)
		MapChunk(25), // Metyr arena
		MapChunk(41, 1), // Bonny Gaol
		MapChunk(40, 2), // Darklight Catacombs
		MapChunk(61, 48, 49),
		MapChunk(61, 49, 49),
		MapChunk(61, 50, 49),
		MapChunk(61, 51, 49),
...
MapFragments(goblin::flag::SouthernShore,
	{
		MapChunk(22), // Stone Coffin Fissure
		MapChunk(61, 49, 40),
		MapChunk(61, 50, 40),
		MapChunk(61, 51, 40),
		MapChunk(61, 52, 40),
...
MapFragments(goblin::flag::RauhRuins,
	{
		MapChunk(42, 3), // Taylew's Ruined Forge
		MapChunk(40), // Fog Rift Catacombs
		MapChunk(40, 1), // Scorpion River Catacombs
		MapChunk(61, 44, 49),
		MapChunk(61, 45, 49),
		MapChunk(61, 46, 49),
		MapChunk(61, 47, 49),
